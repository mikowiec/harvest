...
GLAPI GLint APIENTRY gluUnProject4 (GLdouble winX, GLdouble winY, GLdouble winZ, GLdouble clipW, const GLdouble *model, const GLdouble *proj, const GLint *view, GLdouble nearp, GLdouble farp, GLdouble* objX, GLdouble* objY, GLdouble* objZ, GLdouble* objW);
